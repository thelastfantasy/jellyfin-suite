...
const i = "jfs-enhancer-root";
let o = null;
function l(e, n) {
  s(), n.on(e, "playbackstart", () => t()), o = new MutationObserver(() => t()), o.observe(document.body, { childList: !0, subtree: !0 }), t();
}
function t() {
  const e = document.querySelector(".videoPlayerContainer");
  if (!e || document.getElementById(i) || !e.querySelector("video.htmlvideoplayer")) return;
  const r = document.createElement("div");
  r.id = i, e.appendChild(r);
}
class c {
  constructor({ playbackManager: n, events: r }) {
    s(), l(n, r);
  }
}
export {
