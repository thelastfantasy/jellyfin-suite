...
const QR_URL: &str = "https://github.com/thelastfantasy/jellyfin-suite";
...
pub fn render_qr_in_strip(
    ...
    for my in 0..module_count {
        for mx in 0..module_count {
            if is_finder_area(mx, my, module_count) {
                continue;
            }
